...
class Layer:
    ...
    def scroll(self, screen_width, dx=0):
        ...
        self.surface.fill((10,20,30))
        self.surface.set_colorkey((10,20,30))
...
class Visualize:
    ...
    def __init__(self, resolution, dist=0, unit=None, fullscreen=False, title=''):
        ...
        self.screen = pygame.display.set_mode(resolution, pygame.HWSURFACE|pygame.FULLSCREEN|pygame.DOUBLEBUF)#.convert_alpha()
    ...
    def _transition(self):
        #screen_array = pygame.PixelArray(self.screen.copy())
...
#         if self.title:
#             self._center(self.title, font=self.head_font, color=(50,)*3, y=440)
...
#         while i<=50:
#             i+=1
#             pygame.display.update(self.screen.blit(t.anim(), (50,300)))
#             pygame.time.wait(100)

        
        #self.write_down('thanks for the support', 20)
...
class GameVis(ClientVis):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.layers= [ Layer('TLO.png', height=10), Layer('BUDYNKI.png', height=210),
        ...
        self.screen_half_segm = self.resolution[0]/2-20-64        
        ...
        for i,p in enumerate(players):
            if p:
                ...
                self.screen.blit(self.riders[i].img_surf, self.riders[i].pos,
                                 self.riders[i].show())
#                 self.screen.blit(self.head_font.render(' 00.0 km/h', False,
...
if __name__ == '__main__':
    ...
    vis = GameVis((640,480), unit=1, dist=200, title='cmwc')
    #vis.show_inputs()
    vis.start()
    pos=0
    while pos < vis.dist:
        vis.update_race(0, pos)
        pos+=1
